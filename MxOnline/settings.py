...
JWT_AUTH = {
    'JWT_EXPIRATION_DELTA': datetime.timedelta(hours=24),  # token 过期时间
    'JWT_AUTH_HEADER_PREFIX': 'Bearer',
    # 'JWT_RESPONSE_PAYLOAD_HANDLER': 'apps.utils.jwt.jwt_response_payload_handler',
