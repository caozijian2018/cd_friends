...
class CoursesViewSet(CreateModelMixin, ListModelMixin, RetrieveModelMixin, viewsets.GenericViewSet, UpdateModelMixin):
...
class CourseApiView(APIView):
    def get(self, request, *args, **kwargs):
        ...
        return Response(courses.data, status=status.HTTP_201_CREATED)
